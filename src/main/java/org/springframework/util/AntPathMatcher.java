...
public class AntPathMatcher implements PathMatcher {
	...
	protected boolean doMatch(String pattern, String path, boolean fullMatch,
		...
		String[] pattDirs = splitWorker(pattern, this.pathSeparator, this.trimTokens, true);
		String[] pathDirs = splitWorker(path, this.pathSeparator, this.trimTokens, true);
	...
	public String extractPathWithinPattern(String pattern, String path) {
		String[] patternParts = splitWorker(pattern, this.pathSeparator, this.trimTokens, true);
		String[] pathParts = splitWorker(path, this.pathSeparator, this.trimTokens, true);
    ...
    // The below is taken whole heartedly from commons-lang and adapted for use here.
    // The original path matcher used Spring's StringUtils tokenizer: micro benmark resutls from jmh
    /**
     * Benchmark                             Mode Thr    Cnt  Sec         Mean   Mean error    Units
     o.g.s.MeasureSplit.splitChar         thrpt   2      1    5     6414.969          NaN ops/msec
     o.g.s.MeasureSplit.splitChar         thrpt   4      1    5     8474.642          NaN ops/msec
     o.g.s.MeasureSplit.splitChar         thrpt   8      1    5     8517.749          NaN ops/msec
     o.g.s.MeasureSplit.splitChar         thrpt  16      1    5     8502.399          NaN ops/msec
     o.g.s.MeasureSplit.splitTokenized    thrpt   2      1    5     3184.627          NaN ops/msec
     o.g.s.MeasureSplit.splitTokenized    thrpt   4      1    5     3696.500          NaN ops/msec
     o.g.s.MeasureSplit.splitTokenized    thrpt   8      1    5     2771.072          NaN ops/msec
     o.g.s.MeasureSplit.splitTokenized    thrpt  16      1    5     3260.001          NaN ops/msec
     *
     */
    ...
    private static String[] splitWorker(final String str, final String separatorChars, final boolean trimTokens, final boolean ignoreEmptyTokens) {
        boolean preserveAllTokens = !ignoreEmptyTokens;
            ...
            while (i < len) {
                if (Character.isWhitespace(str.charAt(i))) {
                    if (match || preserveAllTokens) {
                        String s;
                        list.add( ( (s = str.substring(start, i))!=null && trimTokens? s.trim() : s) );
                        match = false;
                    }
                    start = ++i;
                    continue;
